...
//redirect to dashbaord page if the user is already logged in
if(!empty($_SESSION['userId'])){
    if($_SESSION['user_type'] == 'admin'){
        $redirectUrl = "tables.php";
    } else {
...
if(isset($_POST['email'])){
    ...
    $userInfo = $dbObj->getUserInfo($userName,$pwd);
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" id="userFrm" method="post">
                                        ...
                                        <a href="#" id="loginFrm" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </a>
                                        <hr>
